...
import { type PropItem, parse } from 'react-docgen-typescript'
...
function extractDefaultValue(prop: PropItem): string | null {
...
function main() {
	...
	for (const file of files) {
		...
		if (doc) {
			...
			console.log(
				`  ✓ Generated ${componentName}.json (${doc.props.length} props)`,
			)
