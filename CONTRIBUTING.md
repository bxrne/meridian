...
2. Clone your fork: `git clone https://github.com/bxrne/meridian.git`
3. Navigate to the project directory: `cd meridian`
...
If you have any questions, please [open an issue](https://github.com/bxrne/meridian/issues/new) for discussion.
